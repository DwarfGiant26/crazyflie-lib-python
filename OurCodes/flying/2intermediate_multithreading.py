...
#path 4
start = [(0.68,0.34,1),(1.87,-0.16,0.34),(0.04,0.53,0.83)] #for scf, scf2, and scf3 / id no 1,2,and 3 / uri1, uri2, and uri3 respectively
intermediate = [(1.34,0.46,0.4),(0.70,0.76,0.75)]
destination = [(1.65,1.20,0.10),(0.59,1.13,1),(1.19,1.12,0.13)]
path_name = [['F2','B2','F1','A1'],['B1','B2','F1','E2'],['J1','B2','F1','A/E1']]
...
def write_log_history():
    folder_name = f"/home/alan/drone/Ours/OurCodes/flying/2Intermediate/path_4/wind_speed_0/wind_direction_{WIND_ANGLE}"
